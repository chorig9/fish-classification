  ...
  """
    ...
    with tf.name_scope(layer_name):
        ...
        with tf.name_scope('Wx_plus_b'):
            boxes = tf.matmul(bottleneck_input, layer_weights) + layer_biases
    ...
    tf.summary.scalar('box_l2_loss', l2_loss_mean)

    with tf.name_scope('train'):
        train_step = tf.train.MomentumOptimizer(FLAGS.learning_rate, 0.9).minimize(
            l2_loss)

    return (train_step, l2_loss_mean, bottleneck_input, ground_truth_input,
            final_tensor)
